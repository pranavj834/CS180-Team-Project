# Team Project - Phase 3 (updated 12/6)
...
and receive Packet objects. It contains methods that is used by the Screen class to carry out user actions,
such as adding and deleting accounts and reservations and logging in and logging out.
...
Functionality: Stores booking details, namely name, username, date, time, number of people, and a list of seats
